...
#include "PDUDataSmResp.h"

////////////////////////////////////////////////////////

class CPDUDataSmRespImpl : public IPDUDataSmResp{
public:
	CPDUDataSmRespImpl();
	virtual ~CPDUDataSmRespImpl();
...
////////////////////////////////////////////////////////
IMPLEMENT_CH_REFCOUNTING( IPDUDataSmResp, CPDUDataSmRespImpl )

////////////////////////////////////////////////////////
PDU_BASICS_DEFINITION( CPDUDataSmRespImpl )

////////////////////////////////////////////////////////
CPDUDataSmRespImpl::CPDUDataSmRespImpl(){
}
...
////////////////////////////////////////////////////////
void 
CPDUDataSmRespImpl::Initialize( CH<IRawBuffer> rawBuffer, boost::shared_ptr<AsyncSocket> inSocket ){
m_pSocket = inSocket;
...
////////////////////////////////////////////////////////
void
CPDUDataSmRespImpl::ProcessPDUEventIn( SP<PDUEventHandler> EventHandler ){
EventHandler->OnPDUEventHandlerIn ( this );
}

////////////////////////////////////////////////////////
void
CPDUDataSmRespImpl::ProcessPDUEventOut( SP<PDUEventHandler> EventHandler ){
EventHandler->OnPDUEventHandlerOut ( this );
}

////////////////////////////////////////////////////////
CH<IRawBuffer>
CPDUDataSmRespImpl::GetRawData(){
