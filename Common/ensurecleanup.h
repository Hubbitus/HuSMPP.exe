...
//-88 MakeCleanupClassX(CEnsureCloseSocket,       SOCKET,    closesocket, INVALID_SOCKET );
...
//-54 MakeCleanupClass(CEnsureCloseServiceHandle, SC_HANDLE, CloseServiceHandle);
//-54 MakeCleanupClass(CEnsureCloseWindowStation, HWINSTA,   CloseWindowStation);
